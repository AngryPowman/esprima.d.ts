...
declare module esprima {
    var version: string;
    function parse(code: string, options?: Options, delegate?: (node: any, meta: any) => void): Syntax.Program;
    ...
    module Syntax {
        ...
        interface Function extends Node {
            ...
            body: BlockStatementOrExpression // Blockstatement | Expression
            generator: boolean
            expression: boolean
        }
        ...
        interface ForStatement extends Statement {
            init: VariableDeclaratorOrExpression // VariableDeclaration | Expression | null
            test: SomeExpression // | null
            update: SomeExpression // | null
            body: SomeStatement
        }
        interface ForInStatement extends Statement {
            left: VariableDeclaratorOrExpression // VariableDeclaration |  Expression
